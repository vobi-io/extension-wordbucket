<template>
  <div class="loader" v-if="!ios">Loading...</div>
   <div class="ispinner gray animating" v-else>
...
.loader {
  ...
  position: relative;
  text-indent: -9999em;
  border-top: 1.1em solid rgba(96,125,139, 0.2);
  border-right: 1.1em solid rgba(96,125,139, 0.2);
  border-bottom: 1.1em solid rgba(96,125,139, 0.2);
  border-left: 1.1em solid #607d8b;
